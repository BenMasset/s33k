...
- [x] **Full suite green: 24 suites pass, 158 tests pass.** The 2 previously-failing UI/hook suites (`__tests__/hooks/domains.test.tsx`, `__tests__/pages/domain.test.tsx`) are fixed. Fixes were confined to the test harness and test files (no product code changed):
