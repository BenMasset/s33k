...
- [x] **Full suite green: 30 suites pass, 219 tests pass.** (Was 24/158 at the deploy-readiness pass, then 28/194 before the AI Visibility feature; the two new suites add 2 suites / 25 tests.) The 2 previously-failing UI/hook suites (`__tests__/hooks/domains.test.tsx`, `__tests__/pages/domain.test.tsx`) are fixed. Fixes were confined to the test harness and test files (no product code changed):
