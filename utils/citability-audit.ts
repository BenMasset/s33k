 ...
 * @param {string} domain - A bare hostname, e.g. "getmasset.com".
 * @returns {string} The https origin, e.g. "https://getmasset.com".
 */
 ...
 * Never throws.
 *
 * @param {string} domain - The bare domain, e.g. "getmasset.com".
