...
import { useFetchAiReferrals } from '../../../../services/aiReferrals';
import AiTraffic, { AiTrafficData } from '../../../../components/aitraffic/AiTraffic';
import { useFetchSettings } from '../../../../services/settings';
import Footer from '../../../../components/common/Footer';

const AiTrafficPage: NextPage = () => {
   ...
   const { data: aiReferralsData, isLoading: aiReferralsLoading } = useFetchAiReferrals(
      router,
      activDomain?.domain || '',
      !!activDomain?.domain,
   );
   const theAiTraffic: AiTrafficData = aiReferralsData || {};
