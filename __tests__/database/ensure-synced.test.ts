...
jest.mock('../../database/models/account', () => modelStub);
jest.mock('../../database/models/apiKey', () => modelStub);
jest.mock('../../database/models/invite', () => modelStub);
jest.mock('../../database/models/waitlist', () => modelStub);
